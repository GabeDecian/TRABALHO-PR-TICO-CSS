...
TEST(Sort, Test_Sort_6) //5
{
  ...
  TEST_ASSERT_EQUAL(1, sort(vetor0, 1, Onlogn, 5));
  ...
  TEST_ASSERT_EQUAL(1, sort(vetor5, 20, Onlogn, 5));
  TEST_ASSERT_EQUAL(1, sort(vetor6, 20, On, 5));
  TEST_ASSERT_EQUAL(1, sort(vetor6, 20, On2, 5));
  TEST_ASSERT_EQUAL(1, sort(vetor6, 20, Onlogn, 5));
  ...
  TEST_ASSERT_EQUAL(1, sort(vetor11, 2, Onlogn, 5));
