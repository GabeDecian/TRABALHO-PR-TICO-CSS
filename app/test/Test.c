...
{
  TEST_ASSERT_EQUAL(1, sort(*vetor0, 1, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor0, 1, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor0, 1, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor1, 24, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor1, 24, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor1, 24, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor2, 20, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor2, 20, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor2, 20, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor3, 20, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor3, 20, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor3, 20, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor4, 20, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor4, 20, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor4, 20, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor5, 20, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor5, 20, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor5, 20, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor6, 20, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor6, 20, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor6, 20, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor7, 20, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor7, 20, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor7, 20, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor8, 1, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor8, 1, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor8, 1, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor9, 1, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor9, 1, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor9, 1, 'Onlogn', COUTING));
  //TEST_ASSERT_EQUAL(1, sort(*vetor10, 1, 'On', COUTING));
  //TEST_ASSERT_EQUAL(1, sort(*vetor10, 1, 'On2', COUTING));
  //TEST_ASSERT_EQUAL(1, sort(*vetor10, 1, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor11, 2, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor11, 2, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor11, 2, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(0, sort(*vetor12, 2, 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor12, 2, 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor12, 2, 'Onlogn', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor13, , 'On', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor13, , 'On2', COUTING));
  TEST_ASSERT_EQUAL(1, sort(*vetor13, , 'Onlogn', COUTING));
}
